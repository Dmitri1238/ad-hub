...
urlpatterns = [
    path('', views.ad_list, name='ad_list'),  # Жестко добавляем маршрут для /ads/
    ...
    # Остальные конкретные маршруты
    
    # Общий маршрут для деталей объявления, должен идти в конце
    ...
    path('<slug:slug>/', views.ad_detail, name='ad_detail'),  # последний
